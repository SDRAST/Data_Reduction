...
#import Physics as P
from Data_Reduction.DSN.Tid_data import Tid_scan, \
                                        number_of_channels, \
                                        update_backend
...
def sort_Tid_ASCII_files(files,dss):
  ...
  @param files : list of strings::
    Full path and name of each file to be included in the sorting.
...
def check_backend(path,fname,backends):
  ...
  backends = update_backend(numbers,backends)
  return backends
