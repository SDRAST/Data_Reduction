...
from Data_Reduction.DSN.WVSR import get_Naudet_FFT_dir, parse_scan_files
from Data_Reduction.DSN.WVSR import get_last_scr_file, get_WVSR_parameters
from Data_Reduction.DSN.WVSR.stokes import get_source_averages
...
def get_channel_IDs(metadata):
  ...
  """
  chan_keys = []
  first_scan = list(metadata.keys())[0]
...
def get_sources(scans, noref=True):
  ...
  scannums = list(scans['chan 01'].keys())
